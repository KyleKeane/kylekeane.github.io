...
research, and I run hands-on workshops, master classes, and short
intensives at universities and design schools. Technology worth making
is made with the people who will use it, not delivered to them — the
courses, workshops, and programmes on this page all put the eventual
user inside the design team. Booking and collaboration enquiries via
the [Engage](/engage.html) page.

Highlights:

- **[Principles and Practices of Assistive Technology](/cv.html#principles-and-practices-of-assistive-technology-mit-capstone)**
  — MIT's capstone co-design subject; lead faculty 2022–2024.
- **[The Humanistic Co-Design Initiative](/cv.html#humanistic-co-design-initiative)**
  — the global incubator and fellowship programme I founded, with
  programmes across India, Saudi Arabia, and Uruguay.
- **[Access Bristol](/cv.html#access-bristol-assistive-technology-accelerator)**
  — the assistive-technology accelerator I organise at Bristol.
...
Design and function of interactive hardware systems, with emphasis on
user interaction, embedded technologies, and the principles behind
...
projects, including a conversion MSc student in Computer Science and a
team of immersive-technology MSc students. Student names, project
titles, and years are added incrementally as projects complete.

## Previously taught at MIT

A condensed list of subjects I led or co-taught at MIT between 2015
and 2024. The full course descriptions and the broader teaching
history are on the [CV](/cv.html) page.

- **6.450 / 6.811 / 2.78 / HST.420 — Principles and Practices of
  Assistive Technology** (EECS / Mechanical Engineering / HST). Lead
  faculty 2022–2024; teaching team 2016, 2017, 2018, 2019. The
...
- **3.017 — Modeling, Problem-Solving, Computing, and Visualization**
  (MSE). Lead 2017, 2018.
- **3.001 — Introduction to Materials Science and Engineering** (MSE).
  Co-taught 2016, 2017.
- **6.a01 — Computing Your Freshman Year** (EECS). Freshman seminar
  on using computer programming to augment first-year physics,
...
visualisation modules to MIT subjects 3.012, 3.014, 3.022, 3.024,
3.044, 8.01, and 8.02. The detail is on the [CV](/cv.html) page.

## Short courses, summer schools, and intensives

- **MSE-641 — Methods of Modelling and Simulation for Materials
  Science.** Intermediate Mathematica programming for structures,
...
- **MIT Independent Activities Period (IAP).** Multi-year hands-on
  ...
  and Creativity*, *Algorithmic Art and Computational Design*,
  [*Collaborative Design and Creative Expression using Arduino
  Microcontrollers*](https://ocw.mit.edu/resources/res-3-002-collaborative-design-and-creative-expression-with-arduino-microcontrollers-january-iap-2017/)
  (published on MIT OpenCourseWare), and
...
Four-week intensive summer programme for high-school juniors and
seniors, pairing students with local community members with
disabilities for a co-design project. MIT Lincoln Labs BeaverWorks
Summer Institute — Summer 2018, 2019, 2020.

### Learn CAD and 3D Printing by Making Accessible Teaching Aids

Semester-long weekend programme for middle-school students learning
computer-aided design by modifying existing tactile puzzle templates
into custom teaching aids for local blind students. MIT Lincoln Labs
BeaverWorks Summer Institute — Spring 2021.

## Hackathon mentorship

ATHack@MIT — staff advisor 2016 onwards; HackPrinceton, HackMIT,
HackNYU, HackingArts, and World MakerFaire — judge / mentor /
exhibitor across 2016–2022. The full year-by-year list is on the
[CV](/cv.html) page.

## Full record

Every teaching entry with its tags: the
[Educator CV](/cv-educator.html), or slice by topic, for example
[co-design](/topic-co-design.html), [India](/topic-india.html), or
[hackathons](/topic-hackathons.html).
