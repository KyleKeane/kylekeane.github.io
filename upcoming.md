...
Here's where you can hear me, see my work, or meet me in person over
the coming months — and how to add to the list. I take on a small
number of speaking, teaching, consulting, artistic, and collaborative
engagements each year; recent and forthcoming hosts include reSOUND
New York at Rockefeller Center (cited in the *New York Times*), WBUR
*On Point*, the United Nations, Microsoft, Harvard Law School, the
...
Active research at Bristol — described in depth on the
[Research](/research.html) page:
...
- Immersive and spatial audio for echolocation training, including the
  *Architecting Perceptible Space* spatial-audio system with Alex
  Thompson at Bristol.
- Spatial reasoning in AI systems that need to communicate with people
...
- **Guest Lecturer,** *Case Studies in Public and Private Policy
  Challenges of Artificial Intelligence*, Harvard Law School,
  April 2024.

## Working with me

Running a good engagement at this level means a few things up front: a
venue that works for the speakers it has booked, materials shared in
advance in formats that screen readers handle properly, briefings that
describe slides and visuals as a matter of course, and a single
technical contact who can sign off on the production setup with me ahead
of time. For artistic and installation work that contact is
non-negotiable; I will not turn up to commission an installation I have
not been able to verify.

I read with a screen reader. I do not need an accessibility plan layered
on top of the rest of the production — I need the production to be set
up properly the first time. The events that have gone best are the ones
...
Topics I take keynotes and invited talks on: AI and disability, spatial
and immersive audio, sonification, accessible scientific graphics,
inclusive design, the future of human–information interaction, and
multidisciplinary research practice. I am happy to deliver against an
existing brief or to develop a talk from a one-paragraph prompt.
...
I am available for graduate seminars, undergraduate guest sessions,
intensive master classes for design and engineering programmes, and
departmental colloquia. Format options include single 90-minute
sessions, half-day workshops, multi-day intensives, and short
residencies. I have run guest sessions at the University of Marburg,
the Karlsruhe Institute of Technology, MIT (Comparative Media Studies),
Boston University, and MassArt; master classes and intensives at
Wolfram Summer School, EPFL, Imperial College London, and Hermes
Summer School. Subjects I'm strong on: computational thinking and
inclusive curriculum design; sonification and tactile data
representation; multisensory HCI; humanistic co-design.

### Workshops and short courses

Hands-on workshops on assistive technology, accessibility, sonification,
Wolfram Language, Arduino-based prototyping, Unity for educational game
design, and inclusive curriculum development. I have delivered these in
...
I am regularly on panels at AI, accessibility, immersive audio, and
disability-justice conferences. Recent: *XR for Good* (University of
Bristol), *From Vibration to Visualization: Sensemaking within
...
Scope: accessibility audits and remediation strategy; AI-and-disability
strategy; multisensory and sonification product design; integration work
of the kind I delivered into Wolfram\|Alpha and the first computational
answers in Apple Siri; Section 508 / VPAT authoring; standards-body
advice; expert witness and external review. I work with technology
companies, universities, museums, broadcasters, and standards bodies. I
am available for short engagements (a single audit, a strategy memo) or
for retainer-style ongoing advisory. Past clients and collaborators
include Wolfram Research, Apple, the DIAGRAM Center / Benetech, the
W3C Web Accessibility Initiative, TeachAccess, and PhET Interactive
Simulations.
...
with in-house production teams or build with my own collaborators.

### Research collaboration and PhD supervision

I am actively taking research collaborators and PhD students at the
University of Bristol on intersensory perception, automated production
of audio-tactile graphics, immersive and spatial audio for
echolocation training, perception-aware AI systems, and inclusive
...
describes current supervision.

### Symposia and events I organise

I host and convene events as well as speaking at them. Recent:
...
- **[Emergent Harmonics](https://biglab.co.uk/event/emergent-harmonics),**
  a one-day symposium on innovation at the intersection of assistive
  technology, art, and human echolocation at The Watershed, Bristol,
  14 July 2025 — keynote by Daniel Kish (World Access for the Blind);
  [session recordings on YouTube](https://youtube.com/playlist?list=PLuDhYTU_hDHWav0RJb4qKESUsSpiYFg_M).
- **Unstuffy 01,** a workshop at the MIT Spatial Sound Lab with
  Fayen d'Evie and Lloyd Mst (Access Lab and Library, Melbourne) and
  musician Andy Slater, June 2024.

I am available to programme, host, or co-organise symposia, workshops,
and accelerators for institutions and funders working in these areas.

## How to reach me

Initial enquiries should include the nature of the engagement,
proposed dates, the audience, and a note on the production setup —
