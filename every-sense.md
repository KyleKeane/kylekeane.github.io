---
layout: default
title: Every sense at full resolution
permalink: /every-sense.html
description: Research, sound art, and installations that treat the body's non-visual senses as full-resolution channels for complex information — from audio-tactile graphics and echolocation training to the ECHO installation at reSOUND New York.
nav_include: true
nav_order: 3
nav_label: Every sense
---
...
The same principle runs through my artistic practice. I work as an
immersive, multisensory artist and experimental technologist at the
outer edges of human perception. My practice treats data as a sonic
medium and treats the body's non-visual senses as full-resolution
channels for complex information. Booking enquiries are welcome via
...
the [Performances section below](#performances).
...
The active threads — audio-tactile graphics, echolocation training,
perception-aware AI, and the ongoing Spatial Sound Lab collaboration —
are listed with their current state on
[What's next](/whats-next.html#every-sense-at-full-resolution).
